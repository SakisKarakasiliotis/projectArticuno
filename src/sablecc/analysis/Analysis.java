...
public interface Analysis extends Switch
{
    ...
    void caseATermNExp(ATermNExp node);
    void caseATermMultTerm(ATermMultTerm node);
    void caseATermDivTerm(ATermDivTerm node);
    void caseATermModTerm(ATermModTerm node);
    void caseAExponentTerm(AExponentTerm node);
    void caseAUnsignedExponent(AUnsignedExponent node);
    ...
    void caseANoOrExpCompExp(ANoOrExpCompExp node);
    void caseAAndExprCompTerm(AAndExprCompTerm node);
    void caseANoAndExpCompTerm(ANoAndExpCompTerm node);
    void caseANotExpCompFun(ANotExpCompFun node);
    void caseANoNotExpCompFun(ANoNotExpCompFun node);
    ...
    void caseANoCompExpCompVal(ANoCompExpCompVal node);
