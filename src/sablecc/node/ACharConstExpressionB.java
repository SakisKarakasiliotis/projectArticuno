...
public final class ACharConstExpressionB extends PExpressionB
{
    private TCharConst _charConst_;

    public ACharConstExpressionB()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACharConstExpressionB(
    ...
    {
        ((Analysis) sw).caseACharConstExpressionB(this);
    }
