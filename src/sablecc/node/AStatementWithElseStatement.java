...
public final class AStatementWithElseStatement extends PStatement
{
    private PCondition _condition_;
    private PStatement _thenStmt_;
    private PStatement _elseStmt_;

    public AStatementWithElseStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStatementWithElseStatement(
    ...
    {
        ((Analysis) sw).caseAStatementWithElseStatement(this);
    }
