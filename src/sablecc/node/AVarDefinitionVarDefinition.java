...
public final class AVarDefinitionVarDefinition extends PVarDefinition
{
    private TIdentifier _identifier_;
    private final LinkedList<PNextIdentifier> _nextIdentifier_ = new LinkedList<PNextIdentifier>();
    private PType _type_;

    public AVarDefinitionVarDefinition()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVarDefinitionVarDefinition(
    ...
    {
        ((Analysis) sw).caseAVarDefinitionVarDefinition(this);
    }
