...
public final class AFDefLocalDefinition extends PLocalDefinition
{
    private PFunctionDefinition _functionDefinition_;

    public AFDefLocalDefinition()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFDefLocalDefinition(
    ...
    {
        ((Analysis) sw).caseAFDefLocalDefinition(this);
    }
