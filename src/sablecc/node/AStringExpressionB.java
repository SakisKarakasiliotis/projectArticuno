...
public final class AStringExpressionB extends PExpressionB
{
    private TStringLiteral _stringLiteral_;

    public AStringExpressionB()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAStringExpressionB(this);
    }
